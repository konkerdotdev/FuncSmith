  ...
  describe('markdownItRender', () => {
    ...
    it('should work as expected with code', async () => {
      ...
      expect(actual).toStrictEqual(
        '<pre><code class="language-js"><span class="hljs-variable language_">console</span>.<span class="hljs-title function_">log</span>(<span class="hljs-string">&quot;FOO&quot;</span>);\n</code></pre>\n'
      );
    });
    ...
    it('should work as expected with unrecognized code', async () => {
      ...
      expect(actual).toStrictEqual(
        '<pre><code class="language-malbolge">(=&lt;`#9]~6ZY327Uv4-QsqpMn&amp;+Ij&quot;\'E%e{Ab~w=_:]Kw%o44Uqp0/Q?xNvL:`H%c#DD2^WV&gt;gY;dts76qKJImZk\n</code></pre>\n'
      );
    });
  });
});
